...
/*   Updated: 2025/09/05 13:35:19 by gkamanur         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// prompt
int								my_sprintf(char *buf, size_t size,
									const char *fmt, ...);
...
char							*ft_create_expansion_main(const char *input,
									t_shell *shell);
...
void							redirect_input(t_comnd *c, int prev);
